  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("USCC,enterprise_Name,enterprise_Address,enterprise_Leader,enterprise_type,enterprise_nature,region_name").get().then((res) => {
