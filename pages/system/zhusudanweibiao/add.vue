<template>
  <view class="uni-container">
    <uni-forms ref="form" :value="formData" validateTrigger="bind">
      <uni-forms-item name="dwname" label="单位名称" required>
        <uni-easyinput placeholder="单位名称" v-model="formData.dwname"></uni-easyinput>
      </uni-forms-item>
      <uni-forms-item name="dwtype" label="单位类型" required>
        <uni-easyinput placeholder="单位类型" v-model="formData.dwtype"></uni-easyinput>
      </uni-forms-item>
...
<script>
  ...
  const dbCollectionName = 'danweibiao';
